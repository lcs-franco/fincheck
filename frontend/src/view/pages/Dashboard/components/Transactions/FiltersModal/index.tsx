    ...
    <Modal open={open} onClose={onClose} title="Filtros">
      <div>
        ...
        <div className="space-y-2 mt-2">
          <button className="p-2 rounded-xl !bg-gray-200 w-full text-left text-gray-800 hover:bg-gray-50 transition-colors">
            Nubank
          </button>
          <button className="p-2 rounded-xl w-full text-left text-gray-800 hover:bg-gray-50 transition-colors">
            XP Investimentos
          </button>
          <button className="p-2 rounded-xl w-full text-left text-gray-800 hover:bg-gray-50 transition-colors">
            Dinheiro
