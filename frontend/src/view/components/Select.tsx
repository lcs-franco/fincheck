  ...
  return (
    <div>
      <RdxSelect.Root>
        ...
        <RdxSelect.Portal>
          <RdxSelect.Content className="z-[99] overflow-hidden bg-white rounded-2xl border shadow-[0px_11px_20px_0px_rgba(0,0,0,0.1)]">
            ...
            <RdxSelect.Viewport className="p-2">
              ...
              <RdxSelect.Item
                ...
                className="p-2 text-gray-800 text-sm data-[state=checked]:font-bold outline-none data-[highlighted]:bg-gray-50 rounded-lg transition-colors"
              >
                <RdxSelect.ItemText>Abacate</RdxSelect.ItemText>
              </RdxSelect.Item>
              ...
              <RdxSelect.Item
                ...
                className="p-2 text-gray-800 text-sm data-[state=checked]:font-bold outline-none data-[highlighted]:bg-gray-50 rounded-lg transition-colors"
              >
                <RdxSelect.ItemText>Pêssego</RdxSelect.ItemText>
              </RdxSelect.Item>
            </RdxSelect.Viewport>
